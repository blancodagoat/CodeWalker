...
namespace CodeWalker.World
{
    public class Space
    {
        ...
        private Dictionary<uint, RpfFileEntry> DefaultYndEntries = new();
        private Dictionary<int, HashSet<YndFile>> YndDependentsByArea = new();
        private Dictionary<YndFile, HashSet<int>> YndDependencyAreas = new();
